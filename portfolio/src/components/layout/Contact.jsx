...
<h3 className="text-2xl font-bold mb-4 underline underline-offset-3">Get in Touch</h3>


    <div className="bg-gray-100 shadow-sm hover:shadow-md rounded dark:bg-zinc-900 dark:hover:bg-zinc-800">
        <p className="text-gray-700 mb-3 flex gap-2">  <img src={Mail} className="h-5 m-1 dark:invert"/>  <a href="mailto:mohammedtaha10683@gmail.com"
        className="hover:text-zinc-900 transition font-semibold tracking-wide dark:text-gray-300">
...
<div className="bg-gray-100 shadow-sm hover:shadow-md rounded dark:bg-zinc-900 dark:hover:bg-zinc-800">
    ...
    className="font-semibold transition tracking-wide hover:text-zinc-900 dark:text-gray-300">
        Mohammed Taha</a></p>
</div>
